            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <select disabled name="categoria_id" id="categoria_id" class="form-control select2" style="width: 100%;">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input readonly v-model="precio_anterior_Pro" class="form-control" type="number" id="precio_anterior_Pro" name="precio_anterior_Pro" min="0" value="0" step=".01">
                                </div>
                            </div>
                            <!-- /.form-group -->
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input readonly v-model="precio_actual_Pro" class="form-control" type="number" id="precio_actual_Pro" name="precio_actual_Pro" min="0" value="0" step=".01">
                                </div>
                                <br>
                                <span id="descuento">
                                    @{{generar_descuento}}
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input readonly v-model="porcentaje_descuento_Pro" class="form-control" type="number" id="porcentaje_descuento_Pro" name="porcentaje_descuento_Pro" step="any" min="0" max="100" value="0">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">%</span>
                                    </div>
                                </div>
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <textarea readonly class="form-control ckeditor" name="descripcion_corta_Pro" id="descripcion_corta_Pro" rows="3">
               ...
               <div class="form-group">
                  ...
                  <textarea readonly class="form-control ckeditor" name="descripcion_larga_Pro" id="descripcion_larga_Pro" rows="5">
            ...
            <div class="card card-info">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <textarea readonly class="form-control ckeditor" name="especificacion_Pro" id="especificacion_Pro" rows="3">{!! $producto->especificacion_Pro !!}</textarea>
       ...
       <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <label>Estado</label>
                  <select disabled name="estado_Pro" id="estado_Pro" class="form-control select2" style="width: 100%;">
              ...
              <div class="col-sm-6">
                    ...
                    <div class="form-group clearfix">
                      <div class="custom-control custom-checkbox">
                        <input disabled type="checkbox" class="custom-control-input" id="activo_Pro" name="activo_Pro"
                    ...
                    <div class="custom-control custom-switch">
                      <input disabled type="checkbox"  class="custom-control-input" id="slinderprincipal_Pro" name="slinderprincipal_Pro"
              ...
              <div class="col-md-12">
                <div class="form-group">
                   ...
                   <a class="btn btn-danger" href="{{ route('cancelar','Admin.Producto.index') }}">Cancelar</a>
                     <a class="btn btn-success " href="{{ route('Admin.Producto.edit',$producto->slug_Pro) }}" title="">Editar</a> 
